...
class TestPositionImportAccuracy:
    ...
    async def test_qb_import_accuracy(
        self,
        mock_get_schedules,
        ...
        game_stats = (
            service.db.query(GameStats)
            .filter(GameStats.player_id == "qb1", GameStats.season == 2023)
            .all()
        )
        ...
        base_stats = (
            service.db.query(BaseStat)
            .filter(BaseStat.player_id == "qb1", BaseStat.season == 2023)
            .all()
        )
    ...
    @patch("backend.services.adapters.nfl_data_py_adapter.NFLDataPyAdapter.get_weekly_stats")
    @patch("backend.services.adapters.nfl_data_py_adapter.NFLDataPyAdapter.get_schedules")
    async def test_rb_import_accuracy(
        self,
        mock_get_schedules,
        mock_get_weekly_stats,
        service,
        ...
        game_stats = (
            service.db.query(GameStats)
            .filter(GameStats.player_id == "rb1", GameStats.season == 2023)
            .all()
        )
        ...
        base_stats = (
            service.db.query(BaseStat)
            .filter(BaseStat.player_id == "rb1", BaseStat.season == 2023)
            .all()
        )
    ...
    @patch("backend.services.adapters.nfl_data_py_adapter.NFLDataPyAdapter.get_weekly_stats")
    @patch("backend.services.adapters.nfl_data_py_adapter.NFLDataPyAdapter.get_schedules")
    async def test_wr_import_accuracy(
        self,
        mock_get_schedules,
        mock_get_weekly_stats,
        service,
        ...
        game_stats = (
            service.db.query(GameStats)
            .filter(GameStats.player_id == "wr1", GameStats.season == 2023)
            .all()
        )
        ...
        base_stats = (
            service.db.query(BaseStat)
            .filter(BaseStat.player_id == "wr1", BaseStat.season == 2023)
            .all()
        )
    ...
    async def test_fantasy_point_calculation_accuracy(self, service):
        ...
        rb_stats = {"rush_yards": 120, "rush_td": 2, "receptions": 3, "rec_yards": 25, "rec_td": 0}
        ...
        wr_stats = {"receptions": 8, "rec_yards": 120, "rec_td": 1, "rush_yards": 15, "rush_td": 0}
        ...
        te_stats = {"receptions": 6, "rec_yards": 85, "rec_td": 1, "rush_yards": 0, "rush_td": 0}
