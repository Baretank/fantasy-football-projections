...
from backend.api.schemas import ScenarioResponse, ProjectionResponse, ScenarioComparisonResponse
...
class TestScenariosRoutes:
    ...
    def test_get_scenario_projections(self):
        ...
        mock_projections = [MockProjection(player_id_1), MockProjection(player_id_2)]
        ...
        with patch("backend.api.routes.scenarios.ScenarioService") as mock_service:
            ...
            service_instance.get_scenario_projections.assert_called_once_with(
                scenario_id=scenario_id, position="QB", team=None
            )
    ...
    def test_clone_scenario(self):
        ...
        with patch("backend.api.routes.scenarios.ScenarioService") as mock_service:
            ...
            response = client.post(
                f"/scenarios/{source_scenario_id}/clone?name={new_name}&description={new_description}"
            )
    ...
    def test_compare_scenarios(self):
        ...
        # Request data
        request_data = {"scenario_ids": [scenario_id_1, scenario_id_2], "position": "QB"}
        ...
        class MockScenarioComparison:
            def __init__(self):
                ...
                self.players = [MockComparisonPlayer()]
        ...
        class MockComparisonPlayer:
            def __init__(self):
                ...
                self.position = "QB"
                self.scenarios = {
                    "Baseline 2025": {"half_ppr": 350.5, "pass_yards": 4800, "pass_td": 38},
                    "High Passing Volume": {"half_ppr": 390.2, "pass_yards": 5200, "pass_td": 42},
                }
        ...
        with patch("backend.api.routes.scenarios.ScenarioService") as mock_service:
            ...
            service_instance.compare_scenarios.assert_called_once_with(
                scenario_ids=request_data["scenario_ids"], position=request_data["position"]
            )
