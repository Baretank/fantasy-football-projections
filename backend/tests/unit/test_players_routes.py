...
class TestPlayersRoutes:
    ...
    def test_get_players_success(self):
        ...
        with patch("backend.api.routes.players.QueryService") as mock_service:
            ...
            service_instance.get_players_optimized = AsyncMock(
                return_value=(mock_players, mock_total_count)
            )
    ...
    def test_search_players(self):
        ...
        mock_players = [
            {"player_id": player_id, "name": "Patrick Mahomes", "team": "KC", "position": "QB"}
        ]
        ...
        with patch("backend.api.routes.players.QueryService") as mock_service:
            ...
            service_instance.search_players.assert_called_once_with(
                search_term="Mahomes", position=None, limit=20
            )
    ...
    def test_get_player_by_id(self):
        ...
        mock_player_data = {
            ...
            "projection": {"pass_yards": 4800, "pass_td": 38, "half_ppr": 380.5},
        }
        ...
        with patch("backend.api.routes.players.QueryService") as mock_service:
            ...
            # Verify service was called correctly
            service_instance.get_player_stats_optimized.assert_called_once_with(player_id=player_id)
    ...
    def test_get_player_stats(self):
        ...
        mock_player_stats = {
            ...
            "team": "KC",
            "position": "QB",
            "stats": {"2023": {"pass_yards": 4800, "pass_td": 38, "interceptions": 14}},
        }
        ...
        with patch("backend.api.routes.players.QueryService") as mock_service:
            ...
            service_instance.get_player_stats_optimized.assert_called_once_with(
                player_id=player_id, seasons=seasons
            )
