...
def sample_players(test_db):
    ...
    players = [
        Player(player_id=str(uuid.uuid4()), name="Patrick Mahomes", team="KC", position="QB"),
        Player(player_id=str(uuid.uuid4()), name="Travis Kelce", team="KC", position="TE"),
        Player(player_id=str(uuid.uuid4()), name="Brock Purdy", team="SF", position="QB"),
        Player(player_id=str(uuid.uuid4()), name="Christian McCaffrey", team="SF", position="RB"),
    ]
