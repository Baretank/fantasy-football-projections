...
def create_average_baseline(db, season: int) -> Dict[str, Any]:
    ...
    scenario.parameters = {
        ...
        "stats_multipliers": {
            ...
            "TE": {"receptions": 1.0, "rec_yards": 1.0, "rec_td": 1.0},
        },
    }

    db.commit()

    return {"scenario_id": scenario.scenario_id, "name": scenario.name, "season": season}
...
def create_optimistic_baseline(db, season: int) -> Dict[str, Any]:
    ...
    scenario.parameters = {
        ...
        "stats_multipliers": {
            ...
            "TE": {"receptions": 1.1, "rec_yards": 1.1, "rec_td": 1.15},
        },
    }
...
def create_conservative_baseline(db, season: int) -> Dict[str, Any]:
    ...
    scenario.parameters = {
        ...
        "stats_multipliers": {
            ...
            "TE": {"receptions": 0.95, "rec_yards": 0.95, "rec_td": 0.9},
        },
    }
...
def main():
    ...
    parser.add_argument(
        "--type",
        choices=["all", "average", "optimistic", "conservative", "team"],
        default="all",
        help="Type of baseline scenario to create",
    )
