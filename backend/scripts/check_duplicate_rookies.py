            ...
            if answer.lower() == 'y':
                for name in duplicates:
                    ...
                    for i, d in enumerate(dupes):
                        print(f"{i+1}. ID: {d.player_id}, Position: {d.position}, Team: {d.team}, Created: {d.created_at}")
                    ...
                    try:
                        ...
                        if 1 <= choice <= len(dupes):
                            ...
                            print(f"Removing {player_to_remove.name} with ID {player_to_remove.player_id}")
